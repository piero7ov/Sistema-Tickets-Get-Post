<?php
//SELECT (listado real) + Nuevo ticket (INSERT) + Acciones (UPDATE estado) por POST
...
/* URL de retorno (para volver al listado con los filtros actuales) */
          ...
          <?php else: ?>
            <?php foreach ($tickets as $t): ?>
              <tr>
                ...
                <td>
                  <!-- Botones POST para cambiar estado -->
