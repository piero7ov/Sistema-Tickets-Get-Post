<?php
// front.php — Front público simple: crear ticket (INSERT) sin login
...
<head>
  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    /* Inputs: por defecto 100% (así no se salen ni se quedan cortos) */
    ...
    /* Grid limpio para los 3 primeros campos */
    .row{
      display:grid;
